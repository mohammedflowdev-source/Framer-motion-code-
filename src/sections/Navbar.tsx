                        ...
                        <AnimatePresence>
                            {isOpen && (
                                <motion.div
                                    ...
                                    <div className="lg:hidden flex flex-col items-center pb-4 gap-4 py-4 ">
                                        {navLinks.map(link => (
